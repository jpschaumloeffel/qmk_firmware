...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├─────┼─────┼─────┼─────┼─────┼─────┼┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │  Tb │  x  │  v  │  l  │  c  │  w  ││  k  │  h  │  g  │  f  │  q  │ sz  │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │  M3 │  U  │  I  │  A  │  E  │  O  ││  S  │  N  │  R  │  T  │  D  │  Y  │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │ LSh │  ü  │  ö  │  ä  │  p  │  z  ││  b  │  m  │  ,  │  .  │  j  │ Rsh │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │ Ctl │ Fn  │ Alt │ M4  │ GUI │ Spc ││ Ret │ M4  │ Alt │  Fn │     │     │
     * └─────┴─────┴─────┴─────┴─────┴─────┴┴─────┴─────┴─────┴─────┴─────┴─────┘
     */
    [_NL1] = LAYOUT_ortho_5x12(
        ...
        KC_LNSH, UC_UE,   UC_OE,   UC_AE,   KC_P,    KC_Z,    KC_B,    KC_M,    KC_COMM, KC_DOT,  KC_J,    KC_RNSH,
        KC_LCTL, MO(_FN), KC_LALT, KC_MOD4, KC_LGUI, KC_SPC,  KC_ENT,  KC_MOD4, KC_RALT, MO(_FN), KC_NO,   KC_NO
    ),

    [_NL2] = LAYOUT_ortho_5x12(
        ...
        _______, UC_UE_C, UC_OE_C, UC_AE_C, _______, _______, _______, _______, _______, _______, _______, _______, 
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    [_NL3] = LAYOUT_ortho_5x12( /* Neo2 layer 3 */
        ...
        _______, KC_HASH, KC_DLR , KC_PIPE, KC_TILD, KC_GRAVE,KC_PLUS, KC_PERC, KC_DQUO, KC_QUOT, KC_SCLN, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    [_NL4] = LAYOUT_ortho_5x12( /* Neo2 layer 4 */
        ...
        _______, _______, KC_TAB , KC_INS , KC_ENT , _______, KC_COLN, KC_1   , KC_2   , KC_3   , _______, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_0   , _______, _______, _______, _______
    ),

    [_FN] = LAYOUT_ortho_5x12( /* FUNCTION */
        KC_F12 , KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
        _______, _______, _______, _______, RGB_HUD, RGB_HUI, _______, _______, _______, _______, UC_PREV, UC_NEXT,
        _______, RGB_M_G, RGB_M_R, _______, RGB_SAD, RGB_SAI, _______, _______, _______, _______, _______, QK_RBT,
        _______, RGB_M_SN,RGB_M_P, _______, RGB_VAD, RGB_VAI, _______, _______, _______, _______, _______, _______,
        _______, MO(_FN), RGB_TOG, _______, RGB_RMOD,RGB_MOD, _______, _______, _______, MO(_FN), _______, _______
    )
};
